<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container" id="navbar-container">
            ...
            <!---- AWARDS ---->
            <li class="nav-item dropdown">
                <NuxtLink class="nav-link dropdown-roggle" id="navbarAwardsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" to="">Awards</NuxtLink>
                    <ul class="dropdown-menu" aria-labelledby="navbarAwardsDropdown">
