...
export default {
  ...
  mounted() {
    ...
    // Hiding the Integrated Human Practices on initial load
    const integratedHumanPracticesDiv = this.$el.querySelector('#integrated-human-practices');
    if (integratedHumanPracticesDiv) {
      integratedHumanPracticesDiv.style.display = 'none';
    }
  },
  ...
  methods: {
    ...
    showHumanPracticesContent() {
      ...
      const humanPracticesDiv = this.$el.querySelector('#human-practices');
      if (humanPracticesDiv) {
        humanPracticesDiv.style.display = 'block';
      }
    },
    ...
    showIntegratedHumanPracticesContent() {
      ...
      const integratedHumanPracticesDiv = this.$el.querySelector('#integrated-human-practices');
      if (integratedHumanPracticesDiv) {
        integratedHumanPracticesDiv.style.display = 'block';
      }
    },

    hideAllContents() {
      const contentDivs = this.$el.querySelectorAll('.content-section');
