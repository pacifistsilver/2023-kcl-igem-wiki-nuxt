      ...
      <main>
        <div class = "container">
            ...
            <div id = "content-main" class="col-lg-9">
              ...
              <div class="section-content" id="human-practices">
                ...
                <div class="section-content" id="integrated-human-practices">
...
export default {
  ...
  methods: {
    ...
    hideAllContents() {
      const contentDivs = this.$el.querySelectorAll('.section-content');
