          ...
          <div class="headBlock__inner">
            <div class="headBlock__titlesWrapper">
              ...
              <h1 class="headBlock__title__container">
                <span class="headBlock__subtitle__line " data-aos="fade-left" data-aos-duration="0"
                  data-aos-delay="0" data-aos-once="true">
                  Introducing
                </span>
                <span class="headBlock__title__line  " data-aos="fade-right" data-aos-duration="500"
                  data-aos-delay="500" data-aos-once="true">ColoEcho</span>
                <span class="headBlock__description__line" data-aos="fade-up" data-aos-duration="1250"
      ...
      <section class="container">
        <div class="row">
          <div class="col tabbed gallery">
            <ul class="thumbnails">
              <li>
                <div class="c-borderedImage index_p-headBlockImage js-indexHeadBlockImage --portrait"
                  data-is-loaded="true"
                    ...
                    <div class="c-borderedImage__inner js-borderedImageInner"
                      ...
                      <picture>
                        ...
                        <img class="js-borderedImageImage"
                          src="https://www.dogecore.com/cdn/shop/files/thicc_100x.png?v=1669641822" alt=""
                          decoding="async">
                      </picture>
                    </div>
                  </div>
