...
<template>
  <div class="bgObjects" aria-hidden="true">
    <div class="bgObjectItem" data-is-template="true">
        ...
        <div class="headBlock__titlesWrapper row ">
          <div class="col-9">
            <h1 class="headBlock__title__container row">
              <span class="headBlock__subtitle__line white text-center col-11 " data-aos="fade-left" data-aos-duration="0"
                data-aos-delay="0" data-aos-once="true">
                Introducing
              </span>
              <span class="headBlock__title__line  white col-12 text-center " data-aos="fade-right"
                data-aos-duration="500" data-aos-delay="500" data-aos-once="true">ColoEcho</span>
              <span class="headBlock__description__line  col-12 text-center " data-aos="fade-up" data-aos-duration="1250"
          ...
          <div class="index-headBlock__visual col-3">
            <div class="index_headBlockImage-container" data-aos="fade-left" data-aos-duration="1250"
      ...
      <div class="container">
        <div class="row">
          <div class="col-6" data-aos="fade-up" data-aos-duration="1200">
            ...
            <p class="index-text">
              Colorectal cancer ranks among the significant contributors to cancer-related mortality, responsible for a
              substantial portion of cancer-related deaths.
              Approximately 15% of all cancer fatalities are attributed to colorectal cancer.
              This cancer type claims more lives annually than certain other prevalent cancers like ovarian and liver
              cancers,
              underscoring its impact. Regrettably, symptoms typically manifest in the later stages of the disease when
